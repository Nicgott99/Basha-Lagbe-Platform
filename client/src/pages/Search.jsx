  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Properties Grid */}
        {loading ? (
          // SkeletonCard: purpose-built shimmer that matches PropertyCard layout exactly
          // Replaces the previous ad-hoc animate-pulse divs with the dedicated component
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <SkeletonCard count={pageSize || 6} variant="default" />
          </div>
